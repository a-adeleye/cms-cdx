          ...
          <FormItem>
            ...
            <FormControl>
              {(() => {
                ...
                if (field.type === "ai-draft") {
                  return <FieldComponent {...sharedProps} contentName={contentName} runBeforeSubmitHooks={runBeforeSubmitHooks} />;
                }
...
const EntryForm = ({
  ...
  const renderFields: RenderFields = useCallback(
    ...
    [contentName, onChangeRegistered],
  );
