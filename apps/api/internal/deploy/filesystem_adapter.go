...
func (a FilesystemAdapter) Deploy(ctx context.Context, site models.Site, build models.Build, outputPath string) (*DeployResult, error) {
	...
	return &DeployResult{
		Provider: provider,
		URL:      deploymentURLForBuild(site, build, provider, config),
...
func deploymentURLForBuild(site models.Site, build models.Build, provider string, config map[string]any) string {
	base := ""
